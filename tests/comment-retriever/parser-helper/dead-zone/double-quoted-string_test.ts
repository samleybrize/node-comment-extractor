...
import { ParserHelperDeadZoneDoubleQuotedString } from '../../../../src';

describe('parser helper: dead zone: double quoted string', () => {
    it('should not be in dead zone by default', () => {
        let parserHelper = new ParserHelperDeadZoneDoubleQuotedString();
