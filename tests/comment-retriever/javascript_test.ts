...
import { CommentRetrieverJavascript, SourceCodeString, SourceCodeZone } from '../../src';

describe('comment retriever: javascript', () => {
    it('should return all comments', () => {
        let fixtureFilePath     = path.join(__dirname, '../../../tests/fixtures/comment-retriever/sample.js');
    ...
    it('should be able to handle multiple files', () => {
        let fixtureFilePath     = path.join(__dirname, '../../../tests/fixtures/comment-retriever/sample.js');
        let sourceCodeContent   = fs.readFileSync(fixtureFilePath, 'utf8');
        let sourceCode1         = new SourceCodeString('js-sample1', sourceCodeContent);
        let sourceCode2         = new SourceCodeString('js-sample2', sourceCodeContent);
        let commentRetriever    = new CommentRetrieverJavascript();
